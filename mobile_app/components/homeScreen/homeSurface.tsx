...
// // // //   const mediaUri = media.feed_url ?? media.url ?? media.thumbnail_url ?? null;
...
// // //   if (media.media_type === "video") {
// // //     /*
// // //      * Only create a VideoPlayer for:
// // //      *
// // //      * current item
// // //      * previous item
// // //      * next item
// // //      *
// // //      * Far-away videos use only their thumbnail.
// // //      */
...
// // //         <Image
// // //           source={{
// // //             uri: media.thumbnail_url ?? media.feed_url ?? media.url,
// // //           }}
// // //           style={styles.image}
// // //           resizeMode="contain"
// // //         />
...
// // //     return (
// // //       <VideoMedia
// // //         source={media.feed_url ?? media.url ?? ""}
...
// // //   const flatListRef = useRef<FlatList<Listing>>(null);
...
// // //       // ---------------------------------------------
// // //       // AUTOMATICALLY RESUME NEW ACTIVE ITEM
// // //       // ---------------------------------------------
...
// //   if (media.media_type === "image") {
// //     const imageUri = media.feed_url || media.url || media.thumbnail_url || null;
...
// //      * IMPORTANT:
// //      *
// //      * media.url is the original Cloudinary MP4.
// //      *
// //      * Use media.url for expo-video playback.
// //      *
// //      * Do NOT use feed_url here because feed_url may be:
// //      *
// //      * ""
// //      *
// //      * or a Cloudinary URL without the .mp4 extension.
// //      */

// //     const videoUri = media.url;
...
// //           <Text style={styles.noMediaText}>Video unavailable</Text>
// //         </View>
// //       );
// //     }

// //     /*
// //      * Only create VideoPlayer for:
// //      *
// //      * current item
// //      * previous item
// //      * next item
// //      *
// //      * Far-away videos use their thumbnail.
// //      */
...
// //           <Text style={styles.noMediaText}>Video</Text>
// //         </View>
// //       );
// //     }
...
// //     player.play();
// //   }, [player, isScreenFocused, isActive, isMuted, isPaused]);
...
// function NoMedia({ type = "image" }: { type?: "image" | "video" }) {
//   return (
//     <View style={styles.noMedia}>
//       <View style={styles.noMediaIcon}>
//         <Ionicons
//           name={type === "video" ? "videocam-off-outline" : "image-outline"}
//           size={30}
//           color={Colors.textOnDarkMuted}
//         />
//       </View>
...
//         {type === "video" ? "Video unavailable" : "No media"}
//       </Text>
//     </View>
//   );
// }
...
//      * url           = MP4 video
//      *
//      * Never use the MP4 URL inside <Image />.
//      */
...
//             fadeDuration={150}
//             onError={(event) => {
//               console.log("VIDEO THUMBNAIL ERROR:", event.nativeEvent.error);
...
//            * IMPORTANT:
//            *
//            * removeClippedSubviews is intentionally
//            * disabled here.
//            *
//            * Full-screen absolute-positioned images
//            * and native VideoView surfaces can disappear
//            * on Android when clipping is enabled.
//            */
...
function getImageUri(media?: ListingMedia | null): string | null {
  if (!media) {
    return null;
  }
  ...
  return media.feed_url ?? media.url ?? media.thumbnail_url ?? null;
}

function getVideoUri(media?: ListingMedia | null): string | null {
  if (!media || media.media_type !== "video") {
    return null;
  }

  return media.feed_url ?? media.url ?? null;
}
...
function FeedMedia({
  ...
  if (media.media_type === "image") {
    const imageUri = getImageUri(media);
    ...
    return (
      <Image
        ...
        onError={(event) => {
          console.log("================================");
          console.log("HOME IMAGE ERROR:", event.error);
          console.log("IMAGE URL:", imageUri);
          console.log("================================");
        }}
      />
  ...
  if (media.media_type === "video") {
    ...
    const videoUri = getVideoUri(media);
    const thumbnailUri = getImageUri(media);

    // -----------------------------------------------
    // FAR VIDEO
    //
    // Do not create a video player for videos that
    // are far away from the current item.
    // -----------------------------------------------
      ...
      if (thumbnailUri) {
        return (
          <Image
            ...
            transition={150}
            onError={(event) => {
              console.log("FAR VIDEO THUMBNAIL ERROR:", event.error);
            }}
          />
        );
      }
